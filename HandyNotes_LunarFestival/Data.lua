...
ns.setElune = { elune=true, noCoords=true, noContinent=true,
				achievements={ { id=937, }, }, quests={ { id=8868, name="Elune's Blessing", }, }, }
...
ns.setFinery = { finery=true, noCoords=true, noContinent=true, achievements={ { id=626, }, }, }
...
ns.setFSolemnity = { crown=true, tip="Flower of Solemnity",
...
points[ ns.map.azuremyst ] = { -- Azuremyst Isle
	[33134498] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
...
points[ ns.map.darkshore  ] = { -- Darkshore
	...
	[54827242] = { elder=true, achievements={ { id=911, index=12, version=60000, },
...
points[ ns.map.darnassus ] = { -- Darnassus
	[38583028] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
...
points[ ns.map.desolace ] = { -- Desolace
	...
	[99184999] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
...
points[ ns.map.mulgore ] = { -- Mulgore
	[44582416] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
...
points[ ns.map.northernBarrens ] = { -- Northern Barrens
	...
	[07447457] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
...
points[ ns.map.orgrimmar ] = { -- Orgrimmar
	[49095581] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
...
points[ 199 ] = { -- Southern Barrens
	...
	[68562174] = { elder=true, achievements={ { id=911, index=5, version=60000, },
					{ id=911, index=7, versionUnder=60000, }, }, quests={ { id=8680, qType="Seasonal", }, }, },
	[21342531] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
}
...
points[ ns.map.teldrassil ] = { -- Teldrassil
	[27954326] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
...
points[ ns.map.theExodar ] = { -- The Exodar
	[74015747] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[83508520] = ns.setFinery,
	[83508950] = ns.setHonorElders,
	[85709230] = ns.setElune,
...
points[ ns.map.thunder ] = { -- Thunder Bluff
	[71112823] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
...
points[ ns.map.elwynn ] = { -- Elwynn Forest
	[32475305] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	...
	[32135280] = { elderFaction=true, achievements={ { id=915, index=3, version=60000, },
					{ id=915, index=1, versionUnder=60000, }, }, quests={ { id=8646, qType="Seasonal", }, }, },
...
points[ ns.map.eversong ] = { -- Eversong Woods
	...
	[56824734] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
}
...
points[ ns.map.ironforge ] = { -- Ironforge
	[28861626] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
...
points[ ns.map.silvermoon ] = { -- Sivermoon City
	[73068260] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[31505320] = ns.setFinery,
...
points[ ns.map.tirisfal ] = { -- Tirisfal Glades
	[61737269] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"], tip=ns.L["Not in the Undercity. She's above it"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
...
points[ 2070 ] = { -- Wrong Tirisfal Glades
	[61737269] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[61865391] = { elder=true, achievements={ { id=912, index=13, version=60000, },
					{ id=912, index=2, versionUnder=60000, }, }, quests={ { id=8652, qType="Seasonal", }, }, },
	[61957317] = { elderFaction=true, achievements={ { id=914, index=3, version=60000, },
...
points[ ns.map.undercity ] = { -- Undercity
	[65613597] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"], tip=ns.L["Not in the Undercity. She's above it"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
...
points[ ns.map.shattrath ] = { -- Shattrath
	[53293309] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[83508520] = ns.setFinery,
	[83508950] = ns.setHonorElders,
	[85709230] = ns.setElune,
...
points[ ns.map.terokkar ] = { -- Terokkar Forest
	[30452117] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
}
...
points[ 127 ] = { -- Crystalsong Forest
	...
	[29243808] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
}

points[ 125 ] = { -- Dalaran
	[47654374] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[83508520] = ns.setFinery,
	[83508950] = ns.setHonorElders,
	[85709230] = ns.setElune,
...
points[ 249 ] = { -- Uldum
	...
	[83793788] = { elder=true, achievements={ { id=911, index=15, version=60000, },			
					{ id=911, index=13, versionUnder=60000, }, }, quests={ { id=8671, qType="Seasonal", }, }, },
}
...
points[ 390 ] = { -- Vale of Eternal Blossoms
	[62921928] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[85296487] = { seasonalQuest=true, name=ns.L["Lunar Festival Harbinger"],
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
}
