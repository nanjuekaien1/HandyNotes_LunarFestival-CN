...
if ns.locale == "deDE" then
	...
	ns.L["Your map is looking at the wrong time in the zone's history."] = "Your map is looking at the wrong time in the zone's history. If you are presently "
...
elseif ns.locale == "zhTW" then
	...
	ns.L["Try again. Server no response"] = "再試一次，服務器無響應"
...
if ns.locale == "deDE" then
	...
	L["setHistory"] = "The Lunar Festival is a time of celebration for the peoples of Azeroth. At the beginning of each year, "
	...
	L["setHonorElders"] = "For zone Elders look for an icon on the zone map. The faction/dungeon Elder pins are in the event cluster "
		.."in each capital city. Cataclysm is near the Maelstrom on the World Map. These pins will breakdown your "
		.."progress"
...
elseif ns.locale == "zhCN" then
	...
	L["elderNurgenExit"] = "离开地下城后，走这里的小路，很快就可以上坐骑"
	L["taraezorPromo"] = "\n\n感谢您使用我的插件。希望我可以帮到你！ :)\n\n我在 X, BlueSky and Ko-fi 账号是 @Taraezor. 还有我在 curseforge 网站上的项目，您可能会找到更多有用的插件！"
	L["setHistory"] = "春节是全艾泽拉斯的人民欢庆的时节。在一年之初，各个世代的长者会现身各地，"
		.."向所有愿意聆听的人分享智慧。如果你在旅途中遇见了这些尊崇的灵魂，并停下脚步听他们一言，他们会交于你感谢的礼物——先祖硬币，"
		.."这是往昔训诫的实体化身。收集足够的先祖硬币，塞纳里奥议会就会向你出售节日服装、烟花、饰品和配方！"
		.."\n\n塞纳里奥议会的庆祝活动大有来头，因为春节标志着许多陨落半神的回归：戈德林、马洛恩、艾维娜和塞纳留斯。"
		.."但这次的庆典蒙上了一层阴影，半神的一员——年兽，月之女神艾露恩祝福过的狼半神——他从月光林地的湖中崛起，"
		.."背负着永恒的折磨。虽然年兽曾经也是高贵而骄傲的半神，他在上古之战中被燃烧军团的污秽魔法逼疯了。"
		.."年兽是不朽的，这意味着每个新年之初，他都会回到这种疯狂的状态——今年，他的力量也有所增长。"
		.."\n\n巨狼年兽曾经是这个世界的英雄。作为力量与幸运的化身，年兽在上古之战中与英雄们并肩作战，直至屈服于恶魔的魔法。"
		.."他开始袭击过去的盟友，他的怒火遍及艾泽拉斯，所到之处只留下死亡与恐惧。"
		.."年兽最终在月光林地倒下，他现在沉眠于月神湖底。但每年，当春节开始，他便会翻起波浪……"
		.."\n\n（（来自暴雪官方网站  2025年））"
	L["setHonorElders"] = "区域长者可以在区域地图上看到图标。阵营/地下城长者的图标在事件分类中"
					.."在每个主城。大地裂变位于世界地图大漩涡附加，这些图标会显示你的完成进度"
...
elseif ns.locale == "zhTW" then
	...
	L["elderBluewolf"] = "他在這裏面。如果你的陣營沒有控製權，請參閱我的簡易冒險指南！如果你的陣營已經控製，那麽傳送門戶就能正常使用"
	L["elderNurgenExit"] = "離開地下城後，走這裏的小路，很快就可以上坐騎"
	L["taraezorPromo"] = "\n\n感謝您使用我的插件。希望我可以幫到你！ :)\n\n我在 X, BlueSky and Ko-fi 賬號是 @Taraezor. 還有我在 curseforge 網站上的項目，您可能會找到更多有用的插件！"
	L["setHistory"] = "春節是全艾澤拉斯的人民歡慶的時節。在一年之初，各個世代的長者會現身各地，"
					.."向所有願意聆聽的人分享智慧。如果你在旅途中遇見了這些尊崇的靈魂，並停下腳步聽他們一言，他們會交於你感謝的禮物——先祖硬幣，"
					.."這是往昔訓誡的實體化身。收集足夠的先祖硬幣，塞納裏奧議會就會向你出售節日服裝、煙花、飾品和配方！"
					.."\n\n塞納裏奧議會的慶祝活動大有來頭，因為春節標誌著許多隕落半神的回歸：戈德林、馬洛恩、艾維娜和塞納留斯。"
					.."但這次的慶典蒙上了一層陰影，半神的一員——年獸，月之女神艾露恩祝福過的狼半神——他從月光林地的湖中崛起，"
					.."背負著永恒的折磨。雖然年獸曾經也是高貴而驕傲的半神，他在上古之戰中被燃燒軍團的汙穢魔法逼瘋了。"
					.."年獸是不朽的，這意味著每個新年之初，他都會回到這種瘋狂的狀態——今年，他的力量也有所增長。"
					.."\n\n巨狼年獸曾經是這個世界的英雄。作為力量與幸運的化身，年獸在上古之戰中與英雄們並肩作戰，直至屈服於惡魔的魔法。"
					.."他開始襲擊過去的盟友，他的怒火遍及艾澤拉斯，所到之處只留下死亡與恐懼。"
					.."年獸最終在月光林地倒下，他現在沈眠於月神湖底。但每年，當春節開始，他便會翻起波浪……"
					.."\n\n（（來自暴雪官方網站  2025年））"
	L["setHonorElders"]	= "區域長者可以在區域地圖上看到圖標。陣營/地下城長者的圖標在事件分類中"
					.."在每個主城。大地裂變位於世界地圖大漩渦附加，這些圖標會顯示你的完成進度"
	L["Horde be quick here!"] = "部落到這裏快點！"
	L["Moonwell of Purity"] = "純凈月亮井"
	L["Moonwell of Cleansing"] = "凈化月亮井"
	L["Stonetalon Moonwell"] = "石爪峰月亮井"
	L["Alliance need to be very quick with this one"] = "聯盟需要小心完成這項任務"
	L["If Teldrassil looks destroyed then have a chat with Zidormi!"] = "如果泰達希爾看起來被摧毀了，那就在黑海岸（48.8 24.4）找希多爾米對話來切換時間線吧！"
	L["Immediately go left and up high - don't delay"] = "立即向左轉，再往上走 - 別耽擱"
	L["Hide here for respite/cooldowns, as necessary"] = "必要時躲在這裏等待"
	L["Enter Maraudon. Follow the markers"] = "進入瑪拉頓後，跟隨標記"
	L["Whisperwind Grove Moonwell"] = "費伍德森林月亮井"
	L["In the Lariss Pavillion"] = "在拉瑞斯小亭"
	L["In the Dire Maul arena - she's not in the instance"] = "在厄運之槌競技場，他不在副本中"
	L["Dire Maul Moonwell"] = "菲拉斯月亮井（厄運之槌外）"
	L["Visit Zidormi if you see a huge sword stuck into Azeroth"] = "如果你看到一把巨大的劍刺入艾澤拉斯，請與希多爾米交談"
	L["If you are here then you have come the correct way. "] = "如果你在這裏，那麽你走對了路。這是一條筆直路線。副本入口就在前面 "
	L["This is where you respawn if you were wondering"] = "如果你想知道，這裏就是你復生的地方"
	L["Instance entrance/exit"] = "副本入口/出口"
	L["Follow the path.\n\nAt \"Zaetar's Choice\" "] = "沿著這條路走。\n\n在 \"紮爾塔的選擇\" 進入由兩名半人馬守衛的拱門。不要對話"
	     .."左側粉紅色/紫色路徑，右側紅色/橙色路徑"
	L["This is where you \"land\" upon entry to the instance. "] = "這就是你通過 \"傳送門\" 後在副本內出現的地方。直走，往下跳，穿過 河床"
	L["Through here and follow the path"] = "穿過這裏，沿著這條路走"
	L["You now have a choice. Go right. In other words, do not take the (left) ramp upwards"] = "現在你有了一個選擇。「向右走」。換句話說，不要從（左側）坡道往上走"
	L["You're now in an area with a waterfall, a"] = "您現在所在的地區有瀑布、原始巨獸、橋梁和河流。繼續 "
	  .."過橋。不要跳下去。這是一條直線，你不會迷路的！"
	L["Elder Splitrock is here"] = "碎石長者就在這裏"
	L["After Elder Splitrock, don't bother looking"] = "在長者交好任務之後，不要費心在這裏尋找出路。因為沒有 出口"
	L["Nighthaven Moonwell"] = "永夜港月亮井"
	L["Stonetalon Peak Moonwell"] = "石爪峰月亮井"
	L["Enter Zul'Farrak. Follow the markers"] = "進入祖爾法拉克，跟隨標記"
	L["Fly straight into the pink portal at Rut'theran. Immediately turn left and fly up high"] = "直接飛入（達納蘇斯）魯瑟蘭村的傳送門。立即左轉，飛上高空"
	L["Follow the map directly, no need for way-markers!"] = "直接跟著地圖走，不需要路標！"
	L["1) This way"] = "1) 往這邊走"
	L["2) This way"] = "2) 往這邊走"
	L["3) Enter the Ring here, turn in the quest and reverse to exit"] = "3) 在此處進入監獄，上交任務並原路返回"
	L["2) Continue past the barrier"] = "2) 繼續越過障礙物"
	L["3) Go straight up"] = "3) 向前走"
	L["4) Go up the ramp"] = "4) 走上坡路"
	L["1) Fly down to here"] = "1) 飛到這裏"
	L["2) Come this way"] = "2) 走這邊"
	L["3) This way"] = "3) 往這邊走"
	L["4) This way"] = "4) 往這邊走"
	L["5) Enter through here and follow the markers"] = "5) 從這裏進入，沿著標記走"
	L["1) Enter through here"] = "1) 從這裏進入"
	L["5) Continue upwards"] = "5) 繼續向上"
	L["6) Continue upwards"] = "6) 繼續向上"
	L["7) Shortcut upwards. You can fly up to here!"] = "7) 向上的捷徑。您可以飛到這裏！"
	L["8) Continue forward and down the ramp. Portal is to your right"] = "8) 繼續向前，沿著斜坡下行。入口在您的右側"
	L["9) Enter through here and follow the markers"] = "9) 從這裏進入，沿著標記走"
	L["3) Cross the bridge"] = "3) 穿過橋梁"
	L["4) Turn in the quest. Reverse to exit"] = "4) 交好任務，原路返回"
	L["1) Begin by following the path down and then left to here. Keep going"] = "1) 首先沿著小路向下走，然後向左走到這裏。繼續前行"
	L["2) Plough on past the mobs. Depending upon your"] = "2) 繼續前進，越過小怪。根據您的地圖，您可以從以下位置看到石墻長者在這裏"
	L["Can't find him? Speak to Zidormi"] = "找不到他？與希多爾米交談"
	L["Enter through here and follow the markers"] = "從這裏進入，沿著標記走"
	L["Fly through here, keep to the left"] = "飛過這裏，靠左飛行"
	L["Twilight Grove Moonwell"] = "暮色森林月亮井"
	L["Enter The Weeping Cave"] = "進入哭泣的洞穴"
	L["1) Fly through here, keep to the left"] = "1) 飛過這裏，靠左飛行"
	L["2) Drop straight down into here and follow to the left"] = "2) 直接下到這裏，然後向左走"
	L["3) Stick your head up a little and assess the situation"] = "3) 稍微擡起頭，評估一下怪的分布"
	L["Outside the instance"] = "在副本外面"
	L["Lift the portcullis"] = "打開柵欄"
	L["Exit the same way you entered"] = "從原路返回"
	L["Enter the Temple of Atal'Hakkar, also known as the Sunken Temple."] = "進入阿塔哈卡神廟，也被稱為沈沒的神廟。\n\n1) 沿著曲折的小路下行。 2) "
		.."立即潛入水中。 3) 潛遊一會重新浮出水面，沿著小路進入副本，跟著標記走"
	L["Head straight for the other marker"] = "直奔另一個標記"
	L["Drop down in to here. Elder Darkcore is a short walk away"] = "下到這裏。暗靈長者長老就在不遠處"
	L["The achievement text is wrong. Elder Darkcore is NOT"] = "成就文本有誤。暗靈長者不在副本裏。暗靈長者在洛丹倫廢墟之上"
	L["Inside The Weeping Cave"] = "哭泣的洞穴的裏面"
	L["1) Enter the gate. You must kill the boss"] = "1) 進入副本。你必須殺了這個BOSS"
	L["2) Jump down onto the left side stairs"] = "2) 跳下左側樓梯"
	L["3) Go this way"] = "3) 往這邊走"
	L["4) Keep going this way!"] = "4) 繼續走這條路！"
	L["5) Ignore Hadronox. Jump down here"] = "5) 跳過 哈多諾克斯。跳這裏"
	L["6) Now jump down again!"] = "6) 現在再往下跳！"
	L["7) You land here"] = "7) 您降落在這裏"
	L["8) Elder is here"] = "8) 長者在這裏"
	L["9) Exit is this way"] = "9) 出口在這邊"
	L["10) No need to kill Anub'arak"] = "10) 無需擊殺阿努巴拉克"
	L["11) You're welcome! :)"] = "11) 不客氣！ :)"
	L["Enter through here and follow the markers.\n\nThe lowest portal is for The Nexus"] = "這裏進入，跟著標記走。\n\n魔樞的入口在下面"
	L["Actually above the Mightstone Quarry"] = "實際位於 巨石采掘場 上方"
	L["Drop down here, face south and locate the portal and enter"] = "落到這裏，朝南找到入口並進入"
	L["5) So you did decide to come this way. Awesome! Keep going, it's all linear"] = "5) 這樣說，你真的決定來這裏了？好極了 繼續前進，這一切都是直線"
	L["6) Ignore The Prophet. Just keep going"] = "6) 忽略 先知，繼續前行"
	L["7) Jump down and turn around and you'll see a short"] = "7) 跳下去並轉身，你會看到一個短走廊，然後再次跳入水中，接著再跳入水中！"
	L["1) Go through here"] = "1) 從這裏進入"
	L["2) Through here. No need to whoop Trollie"] = "2) 通過這裏。沒必要搭理 托爾戈 的大喊大叫"
	L["3) Through here. You can bypass Novos too"] = "3) 通過這裏。您也可以繞過召喚者諾沃斯"
	L["4) Exit here"] = "4) 從這裏離開"
	L["8) You made it! Follow the passage. You know the rest!"] = "8) 你成功了 跟著通道走 剩下的你都知道了！"
	L["Elder Kilias is located here. Whew! now the exit :(..."] = "長者基裏亞斯就在這裏。呼！現在是出口 :(...\n\n一個可悲的選擇，要麽走回頭路，要麽上樓"
		.."擊敗最後的 Boss（可選）然後跳下去。你自己決定。"
	L["The portal is through here"] = "傳送門在這裏"
	L["1) Jump in the water and exit here"] = "1) 跳入水中，從這裏出去"
	L["2) Through this doorway"] = "2) 穿過這道門"
	L["4) After Elder Ohanzee, reverse to exit"] = "4) 長者奧哈齊交任務後，原路返回"
	L["Here he is!"] = "他在這裏！"
	L["Utgarde Keep is this way. It's at the base"] = "烏特加德城堡在這邊，他在裏面"
	L["This is the correct portal. It's up quite high"] = "這是正確的入口。他在高處（北面）"
	L["BM Hunters doing the Hati quest chain (to get Hati back) "] = "任務鏈「見證者夏拉托爾」時將會進入鏡像。\n\n長者穆拉克在 唐卡洛營地 下面"
	L["Enter through here"] = "從此處進入"
	L["Use this entrance, not the other one"] = "走這個入口，而不是另一個"
	L["1) This way!"] = "1) 往這邊走！"
	L["2) This way!"] = "2) 往這邊走！"
	L["3) This way!"] = "3) 往這邊走！"
	L["4) This way!"] = "4) 往這邊走！"
	L["5) He is here"] = "5) 他就在這裏"
	L["6) Come up this way for a shortcut exit!"] = "6) 從這條路上去，就能找到捷徑出口！"
	L["1) Defeat Dragonflayer Forgemasters to remove the flaming wall barriers"] = "1) 擊殺「掠龍熔煉師」，就可以關閉火墻然後通過"
	L["2) Through this way"] = "2) 通過這種途徑"
	L["3) And when done, just retrace your steps"] = "3) 完成後，只需往裏走"
	L["3) Up the stairs"] = "3) 上樓梯"
	L["8) Now that you're done, it's easiest to keep going"] = "8) 現在你已經快完成了，繼續前進是最容易的了"
	L["9) Up the ramp"] = "9) 上斜坡"
	L["Elder is here"] = "長者在這裏"
	L["1) Through this way"] = "1) 通過這種途徑"
	L["2) Keep going, ignore Svala, she appears to have enough of her own problems"] = "2) 繼續前進，別理席瓦拉·索格蕾，她自己的問題似乎已經夠多了"
	L["5) You've got to do this fight. Kill mobs here. They randomly drop "] = "5) 你必須打贏這場戰鬥。在這裏殺怪。它們會隨機掉落魚叉。使用魚叉發射器"
		.."殺死格拉烏弗，需要開了三槍，斯卡迪下坐騎然後你殺死斯卡迪"
	L["6) The portcullis is now open"] = "6) 柵門現已打開"
	L["7) Jump down"] = "7) 跳下去"
	L["10) Kill Ymiron to open the portcullis. Straight through and exit"] = "10) 殺死伊米隆，打開柵欄。直接穿過並離開"
	L["Glitch Guide: 1) You MUST stand exactly"] = "簡易冒險指南：1) 你必須站在這裏，把臉朝向墻角。\n\n"
		.."如果做不到這一點，那麽你可能站錯了臺階--飛一圈。\n\n"
		.."把臉朝向在墻角，你必須使用 \"沙發墊\" 類玩具，例如："
		.."\"菠蘿形\", \"迷彩\" 和 \"斑馬紋\"等。\n\n您可能會收到警告，您將"
		.."會被傳送到冬擁湖外，所以不要亂動！\n\n您現在在 \"內室\".。"
		.."現在的問題是站起來。暴雪阻止了這一點。法師閃現倒是可以。不一定"
	L["Glitch Guide: 2) After using your Lounge "] = "簡易冒險指南：2) 使用完沙發墊後，準確地走到這裏並轉身 "
		.."您的視角需要是俯視，這樣就能看到被「阻擋」的內部。\n\n"
		.."如果站在這裏，那麽朝向大約 201 度（我的 \"X 和 Y\" 插件顯示的"
		.."坐標）你可以跳到一個圓形凸起的臺階上。\n\n看不到內部？"
		.."就這樣盲目地跳下去！\n\n繼續尋找長老，然後使用紫羅蘭城堡"
		.."的傳送門或者防禦者的傳送門離開"
	L["Use this entrance, not the other one."] = "使用這個入口，而不是另一個"
	L["Nordrassil Moonwell"] = "諾達希爾月亮井"
	L["Wrong version of Uldum. Speak to Zidormi"] = "\124cFFFF0000錯誤的奧丹姆時間線，請與希多爾米交談"
	L["Myrael Lunarbloom"] = "邁瑞爾·月華"
